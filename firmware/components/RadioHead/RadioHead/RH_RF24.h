...
// Maximum raw payload length the RF24 can support
#define RH_RF24_MAX_PAYLOAD_RAW_LEN 4096
...
public:
    ...
    bool        recvRaw(uint8_t* buf, uint16_t* len);
...
private:
    ...
    uint8_t             _buf[RH_RF24_MAX_PAYLOAD_RAW_LEN];
